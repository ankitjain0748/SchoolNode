      ...
      <table align="center" style="max-width: 600px; font-family: Arial, sans-serif;" width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#000" color= "#ffffff">
        ...
        <tr bgcolor="#141414">
          <td style="padding: 40px 2px 10px 2px; text-align: center;">
            <p style="margin: 1px;">
              <img src="https://f003.backblazeb2.com/file/Event-management/support.png" alt="Support Ticket Received">
            </p>
          </td>
        </tr>
        <tr>
          <td style="padding: 40px 0 20px 20px; text-align: left;">
            <p style="margin: 1px; font-size: 14px; font-weight: normal; color:#CCCCCC; text-transform: capitalize;">Hello ${support.support?.name},</p>
          </td>
        </tr>
        <tr>
        ...
        <tr>
          <td style="padding: 0 0 20px 20px;">
            <p style="margin: 1px 2px  2px 1px; font-size: 14px; font-weight: normal; color:#CCCCCC; text-align: left; padding:2px;">
            ...
            <table style="width: 100%; border-collapse: collapse; margin-bottom: 20px; color:#fff;">
              ...
              <tr>
                ...
                <td style="padding: 8px; border: 1px solid #ddd;">${support.support.created_at}</td>
              </tr>
            </table>
          </td>
        </tr>

module.exports = (userName) => {
  ...
  return `
      <table align="center" style="max-width: 600px; font-family: Arial, sans-serif;" width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#000">
        ...
        <tr>
          <td style="padding: 0 0 20px 20px;">
            ...
            <p style="margin: 1px; font-size: 14px; font-weight: normal; color:#CCCCCC; text-align: left;">
              <strong>Blog Post Title:</strong> ${userName.BlogRecord.title}
            </p>
            <p style="margin: 1px; font-size: 14px; font-weight: normal; color:#CCCCCC; text-align: left;">
              <strong>Blog Post Description:</strong> ${userName.BlogRecord.short_content}
            </p>
    ...
    <p style="margin: 1px 10px 2px 5px; font-size: 14px; font-weight: normal; color:#CCCCCC;">
      ...
      <a href="https://www.its-invite.com/${userName.BlogRecord._id}" style="display: inline-block; margin: 10px 10px; padding: 12px 20px; background-color: #007bff; color: white; font-size: 16px; text-decoration: none; border-radius: 5px; text-align: center;">Click here to read the full blog post</a>
    </p>
  </td>

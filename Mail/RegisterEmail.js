    ...
    <table align="center" style="max-width: 600px; font-family: Arial, sans-serif;" width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#000">
      ...
      <tr bgcolor="#141414">
        <td style="padding: 40px 2px 10px 2px; text-align: center;">
          <p style="margin: 1px;">
            <img src="https://f003.backblazeb2.com/file/Event-management/welcome.png" alt="Welcome">
          </p>
        </td>
      </tr>
      <tr>
      ...
      <tr>
        <td style="padding: 0 0 20px 20px;">
          <p style="margin: 1px; font-size: 14px; font-weight: normal; color:#CCCCCC; text-align: left;">
            We’re excited to have you onboard and can’t wait for you to explore everything we have to offer. Here’s what you can do next:
          </p>
          <p style="margin: 10px 0; text-align: center;">
            <a href="https://www.stackearn.com/dashboard" style="display: inline-block; padding: 10px 20px; font-size: 14px; font-weight: bold; text-decoration: none; background-color: #007bff; color: #ffffff; border-radius: 5px;">Your Dashboard Link</a>
          </p>
        </td>
      </tr>
      <tr>
        <td style="padding: 0 0 20px 20px;">
          <p style="margin: 1px; font-size: 14px; font-weight: normal; color:#CCCCCC; text-align: left;">
            If you have any questions or need assistance, feel free to reach out to us:
              ...
              📞 <a href="tel:+9123445678909" style="color: #ffffff; text-decoration: none;">+91 23445678909</a>

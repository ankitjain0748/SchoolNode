...
<p style="margin: 10px 0 15px 0; font-size: 16px; font-weight: bold; color:#ffffff; text-align: left;">
     ...
     Blog Post Title: <br> <span style=" color:#28a745; margin-top:2px ;">${userName.BlogRecord.title}</span>
    
</p>
<p style="margin: 10px 0 20px 0; font-size: 14px; font-weight: bold; color:#FFFFFF; text-align: left;">
    Blog Post Description:
    <br>
    <span style=" color:#ffffff ; margin-top:2px ;">${userName.BlogRecord.short_content}</span>
</p>
    ...
    👉 Read Full Post
        ...
        <tr>
          <td style="padding: 0 0 45px 20px; text-align: left;">
            ...
            Don’t miss out! Feel free to reach out to <a href="mailto:support@stackearn.com" style="color: #ffffff; text-decoration: none;">support@stackearn.com</a>
            </p>
          </td>
        </tr>
        <t

      ...
      <table align="center" style="max-width: 600px; font-family: Arial, sans-serif;" width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#000">
        ...
        <tr bgcolor="#141414">
          <td style="padding: 40px 2px 10px 2px; text-align: center;">
            <p style="margin: 1px;">
              <img src="https://f003.backblazeb2.com/file/Event-management/subscribe.png" alt="Subscription Success">
            </p>
          </td>
        </tr>
        <tr>
        ...
        <tr>
          <td style="padding: 0 0 20px 20px;">
            <p style="margin: 1px; font-size: 14px; font-weight: normal; color:#CCCCCC; text-align: left;">
              Thanks for subscribing to our newsletter! 🎉 You’ll now receive the latest updates, offers, and more directly in your inbox. Stay tuned for exciting content!
            </p>
          </td>
        </tr>
        <tr>

...
const sendEmail = require('./utill/Emailer'); // Adjust path if needed
const CronEmail = require('./Mail/CronEmail'); // Adjust path if needed
const Loggers = require('./utill/Loggers'); // Our new logger

// ✅ DAILY CRON JOB - Every day at midnight (0 0)
...
// ✅ WEEKLY CRON JOB - Every Monday at midnight
...
// ✅ MONTHLY CRON JOB - Runs on the last day of month at 12:15 AM
